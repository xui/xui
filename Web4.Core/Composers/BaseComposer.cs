...
public abstract class BaseComposer
{
    ...
    public virtual bool WriteMutableElement<TView>(ref Html parent, TView view, string? format = null) where TView : IComponent => CompleteFormattedValue();
    public virtual bool WriteMutableElement(ref Html parent, Html partial, string? expression = null, string? format = null) => CompleteFormattedValue();
