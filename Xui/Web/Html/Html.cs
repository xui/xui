...
public ref struct Html
{
    ...
    public bool AppendFormatted(Func<Events.MouseXY, Task> eventHandler, string? format = null, [CallerArgumentExpression(nameof(eventHandler))] string? expression = null) => AppendEventHandler(eventHandler, format ?? Events.MouseXY.Format, expression);
