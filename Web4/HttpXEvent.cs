...
) : Event
{
    ...
    string Event.Subsets.HashChange.OldUrl => OldUrl ?? string.Empty;
    double Event.Subsets.Angles.AltitudeAngle => AltitudeAngle ?? default;
    double Event.Subsets.Angles.AzimuthAngle => AzimuthAngle ?? default;
    int Event.Subsets.WidthHeight.Width => Width ?? default;
    int Event.Subsets.WidthHeight.Height => Height ?? default;
    double Event.Subsets.Pressures.Pressure => Pressure ?? default;
    double Event.Subsets.Pressures.TangentialPressure => TangentialPressure ?? default;
    double Event.Subsets.Tilts.TiltX => TiltX ?? default;
    double Event.Subsets.Tilts.TiltY => TiltY ?? default;
    int Event.Pointer.PointerID => PointerID ?? default;
    double Event.Pointer.Twist => Twist ?? default;
    string Event.Pointer.PointerType => PointerType ?? string.Empty;
    bool Event.Pointer.IsPrimary => IsPrimary ?? default;
    bool Event.Progress.LengthComputable => LengthComputable ?? default;
